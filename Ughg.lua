...
local SelfModules = {
    DefaultConfig = loadstring(game:HttpGet("https://github.com/RegularVynixu/Utilities/blob/aed1d3810ffbadc5d634f4b3af0122d9f56c1b72/Doors%20Entity%20Spawner/DefaultConfig.lua"))(),
    Functions = loadstring(game:HttpGet("https://raw.githubusercontent.com/RegularVynixu/Utilities/aed1d3810ffbadc5d634f4b3af0122d9f56c1b72/Functions.lua"))(),
}
local ModuleScripts = {
                ...
                if entityTable.Config.CanKill and not Char:GetAttribute("IsDead") and not Char:GetAttribute("Invincible") and not Char:GetAttribute("Hiding") and (getPlayerRoot().Position - entityModel.PrimaryPart.Position).Magnitude <= entityTable.Config.KillRange then
                    task.spawn(function()
                        ...
                        if #entityTable.Config.CustomDialog > 0 then
                            firesignal(ReSt.Bricks.EntityInfo.OnClientEvent, entityTable.Config.CustomDialog, "Blue")
                        end
